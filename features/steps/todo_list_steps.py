...
@when('I set relevance {relevance} for task {task_index}')
def step_impl(context, relevance, task_index):
    context.todo_list.set_task_relevance(int(task_index), relevance)
